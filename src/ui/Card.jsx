function Card() {
  return (
    <main className="flex flex-col justify-center items-center gap-8 pt-8 rounded-[0.625rem] w-[90vw] sm:w-[35vw] bg-[var(--dark-greyish-blue)]">
      ...
      <div className="grid grid-cols-[1fr_2rem_2rem_1fr] h-[2rem] w-[90vw]">
        <div className="rounded-full w-[4rem] h-[4rem] bg-[var(--neon-green)] col-start-2 col-span-2 flex justify-center items-center">
